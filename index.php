<?php 
	$musicHost = "../Music/music/"; //音乐文件所在的路径
	$musicImgHost = "../Music/images/music-img/"; //音乐对应图片所在路径
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="Music/css/iconfont.css">
	<link rel="stylesheet" type="text/css" href="Music/css/main.css">
	<script src="Music/js/jquery-3.1.1.js"></script>
	<script src="Music/js/jquery-3.1.1.min.js"></script>
</head>
<body>
	<img src="Music/images/background.jpg" class="bg">
	<div class="panel">
		...
		<div class="song-img">
			<img src="Music/images/default-song-img.jpg" alt="">
			<div class="List">
				<ul>
					<?php 
	...
	<audio src="Music/music/Kelly Clarkson - Catch My Breath.mp3" preload>
	</audio>
</body>
